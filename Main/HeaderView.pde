public class HeaderView{
  ...
  void page(){
    ...
    TextDisplay homeText = new TextDisplay(width/25,DARK,new StringBuffer("Home")); //homebrewed class makes me able to align
    TextDisplay AIText = new TextDisplay(width/25,DARK,new StringBuffer("AI")); //manually the text + some properties
    TextDisplay aboutText = new TextDisplay(width/25,DARK,new StringBuffer("About"));
    ...
    homeText.displayCenteredDim(width/6,0,width/6,this.coordinates.y);
    AIText.displayCenteredDim(width/3,0,width/6,this.coordinates.y);
    aboutText.displayCenteredDim(width/2,0,width/6,this.coordinates.y);
